...
- Added the first uniform ribbon asset: Military Service Ribbon (`static/art/ribbons/military-service-ribbon.webp`).
...
- Added the Unit Citation Ribbon asset (`static/art/ribbons/unit-citation-ribbon.webp`) and linked it to `UNIT_CITATION` in the ribbon catalog.

## Ribbon Asset Update — Meritorious Service Ribbon
- Added the Meritorious Service Ribbon asset (`static/art/ribbons/meritorious-service-ribbon.webp`) and linked it to `MERITORIOUS_SERVICE` in the ribbon catalog.

## Ribbon Asset Update — NCO Leadership Ribbon
- Added the NCO Leadership Ribbon asset (`static/art/ribbons/nco-leadership-ribbon.webp`) and linked it to `NCO_LEADERSHIP` in the ribbon catalog.

## Ribbon Asset Update — Instructor Ribbon
- Added the Instructor Ribbon asset (`static/art/ribbons/instructor-ribbon.webp`) and linked it to `INSTRUCTOR` in the ribbon catalog.


## Ribbon Asset Update — Tour of Duty Ribbon
- Added the corrected Tour of Duty Ribbon asset (`static/art/ribbons/tour-of-duty-ribbon.webp`) and linked it to `TOUR_OF_DUTY` in the ribbon catalog.

## Ribbon Asset Update — Good Conduct Ribbon
- Added the Good Conduct Ribbon asset (`static/art/ribbons/good-conduct-ribbon.webp`) and linked it to `GOOD_CONDUCT` in the ribbon catalog.

## Ribbon Asset Update — Recruiting Ribbon
- Added the Recruiting Ribbon asset (`static/art/ribbons/recruiting-ribbon.webp`) and linked it to `RECRUITING` in the ribbon catalog.
